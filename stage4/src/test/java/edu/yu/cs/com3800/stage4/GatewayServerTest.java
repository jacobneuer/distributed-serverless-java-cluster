...
public class GatewayServerTest {
    ...
    void setupCluster() throws Exception {
        ...
        // Add all peers including the gateway observer
        ...
        // Start the Gateway observer
        gateway = new GatewayServer(
                httpPort,          // 8888
                8040,              // observer’s UDP port
                0,
                0L,                // observer serverId
                peerMap,
    ...
    // TEST 1: Basic compile-and-run request (non-cached)
    @Test
    @Order(1)
    ...
    // TEST 2: Error response (compile failure → 400)
    @Test
    @Order(2)
    void testCompileError() throws Exception {
        ...
        assertTrue(result.contains("Exception"), "Should contain stack trace");
    }
    ...
    void testCaching() throws Exception {
        ...
        String r1 = read(conn1.getInputStream());
        assertEquals("CacheTest", r1.trim());
